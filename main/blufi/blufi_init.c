...
esp_err_t esp_blufi_gap_register_callback(void)
{
    ...
    // rc = esp_ble_gap_register_callback(mine_esp_blufi_gap_event_handler);
    if(rc){
        return rc;
    }
...
{
    ESP_LOGI("BLUFI_INIT", "CONFIG_BT_BLUEDROID_ENABLED - esp_blufi_host_and_cb_init");
...
esp_err_t esp_blufi_host_and_cb_init(esp_blufi_callbacks_t *example_callbacks)
{
    ESP_LOGI("BLUFI_INIT", "CONFIG_BT_NIMBLE_ENABLED - esp_blufi_host_and_cb_init");
    esp_err_t ret = ESP_OK;
